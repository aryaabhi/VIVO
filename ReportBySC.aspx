<%@ Page Language="vb" AutoEventWireup="false" Inherits="SCLE.User.ReportBySC" CodeFile="ReportBySC.aspx.vb" %>
<HTML>
	<HEAD>
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:datagrid id="ProjectDataGrid" OnItemDataBound="ProjectDataGrid_ItemDataBound" runat="server"
				...
				<Columns>
					...
					<asp:BoundColumn HeaderText="Supply Chain" SortExpression="SupplyChain" DataField="SupplyChain"></asp:BoundColumn>
					<asp:BoundColumn HeaderText="SC Element" SortExpression="SCElement" DataField="SCElement"></asp:BoundColumn>
					<asp:BoundColumn HeaderText="SC Sub Element" SortExpression="SCSubElement" DataField="SCSubElement"></asp:BoundColumn>
					...
					<asp:BoundColumn HeaderText="SC Time Current" SortExpression="SCTimeCurrent DESC" DataField="SCTimeCurrent"></asp:BoundColumn>
					<asp:BoundColumn HeaderText="SC Time Expected" SortExpression="SCTimeExpected" DataField="SCTimeExpected"></asp:BoundColumn>
					<asp:BoundColumn HeaderText="SC Time Effect" SortExpression="SCTimeEffect" DataField="SCTimeEffect"></asp:BoundColumn>
					<asp:BoundColumn HeaderText="Probability" DataFormatString="{0:N0}%" SortExpression="SCProbability"
						DataField="SCProbability"></asp:BoundColumn>
