...
#End Region
        ...
        Sub LoadXML()
            ...
            objdata.ReadXml(Server.MapPath("tblLossType.xml"))
        ...
        Sub setEditMode(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
            ...
            objdata.Tables("tblLossType").DefaultView.RowFilter = "LossType='" & x1 & "'"
            If objdata.Tables("tblLossType").DefaultView.Count > 0 Then
        ...
        Sub DelXML(ByVal S As Object, ByVal E As DataGridCommandEventArgs)
            If E.CommandName = "Delete" Then
                If datagrid1.EditItemIndex = -1 Then
                    ...
                    objdata.Tables("tblLossType").DefaultView.RowFilter = "LossType='" & x1 & "'"
                    If objdata.Tables("tblLossType").DefaultView.Count > 0 Then
                        objdata.Tables("tblLossType").DefaultView.Delete(0)
                    End If
                    objdata.Tables("tblLossType").DefaultView.RowFilter = ""

                    objdata.WriteXml(Server.MapPath("tblLossType.xml"))
                    LoadXML()
                Else
                    error5.Visible = "True"
                End If
        ...
        Sub UpdateXML(ByVal s As Object, ByVal e As DataGridCommandEventArgs)
            If e.CommandName = "Update" Then
                ...
                If objdata.Tables("tblLossType").DefaultView.Count > 0 Then
                    ...
                    txt1 = e.Item.FindControl("tblLossType_edit")
                    objdata.Tables("tblLossType").Rows(v1).Item("LossType") = txt1.Text
                    datagrid1.DataSource = objdata
                    datagrid1.DataBind()
        ...
        Sub doInsert(ByVal s As Object, ByVal E As DataGridCommandEventArgs)
            ...
            If E.CommandName = "doAdd" Then
                ...
                tadd1 = E.Item.FindControl("tblLossType_Add")

                If tadd1.Text <> "" Then
                    objdata.Tables("tblLossType").DefaultView.RowFilter = ""
                    dr = objdata.Tables("tblLossType").NewRow()
                    dr(0) = tadd1.Text
                    objdata.Tables("tblLossType").Rows.Add(dr)
                    objdata.WriteXml(Server.MapPath("tblLossType.xml"))
                    LoadXML()
                End If
            End If
