...
Namespace SCLE.User
    Partial Class ReportbyPlantExcel
...
#End Region
        ...
        Sub Page_Load(ByVal Src As Object, ByVal E As EventArgs) Handles MyBase.Load
            ...
            Response.AddHeader("Content-Disposition", "inline;filename=PlantReport.xls")
            ...
            HeaderLabel.Text = "Project List for " & RequestedPlant & " Year " & SelectedYear & "-" & SelectedYear + 1
            ShowDataGrid()
            '	ShowSumGrid()
        ...
        Sub ShowDataGrid()
            MyCommand = New SqlDataAdapter("ProjectsSelectPlant", MyConnection)
            ...
            MyCommand.SelectCommand.Parameters.Add(New SqlParameter("@Plant", SqlDbType.Char, 20))
            MyCommand.SelectCommand.Parameters("@Plant").Value = RequestedPlant
