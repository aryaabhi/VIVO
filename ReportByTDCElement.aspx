<%@ Page Language="vb" AutoEventWireup="false" Inherits="SCLE.User.ReportByTDCElement" CodeFile="ReportByTDCElement.aspx.vb" %>
<HTML>
	<HEAD>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<P>
				...
				<asp:Label id="SubLabel2" runat="server" Width="360px" ForeColor="Navy"></asp:Label></P>
			<P>
