<%@ Page Language="vb" AutoEventWireup="false" Inherits="SCLE.Admin.tblCVCSupplier" CodeFile="tblCVCSupplier.aspx.vb" %>
<HTML>
	<body>
		<center>
				...
				<asp:datagrid id="datagrid1" runat="server" Font-Size="8pt" Font-Name="verdana" Cellpadding="3"
					...
					<Columns>
						<asp:TemplateColumn HeaderText="Sub GBU">
							...
							<FooterTemplate>
								<asp:TextBox id="CVCSupplier_Add" runat="server" Columns="20" />
							</FooterTemplate>
							<EditItemTemplate>
								<asp:Textbox runat="server" Columns="20" id="CVCSupplier_edit" Text='<%# DataBinder.Eval(Container.DataItem,"value") %>' />
							</EditItemTemplate>
						</asp:TemplateColumn>
