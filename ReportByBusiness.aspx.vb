...
Namespace SCLE.User
    Partial Class ReportByBusiness
...
#End Region
        ...
        Sub Year_Refresh_Display()
            If cboYear.SelectedItem.Value = "" Then
                ...
                End If
                HeaderLabel.Text = "Project List for Business " & RequestedBusiness & " Year " & SelectedYear & "-" & Right(SelectedYear + 1, 2)
            Else
                SelectedYear = cboYear.SelectedItem.Value
                HeaderLabel.Text = "Project List for Business " & RequestedBusiness & " Year " & cboYear.SelectedItem.Text
            End If
        ...
        Sub ShowDataGrid()
            MyCommand = New SqlDataAdapter("ProjectsSelectBusiness", MyConnection)
            ...
            MyCommand.SelectCommand.Parameters.Add(New SqlParameter("@Business", SqlDbType.Char, 20))
            MyCommand.SelectCommand.Parameters("@Business").Value = RequestedBusiness
        ...
        Sub ShowSumGrid()
            MyCommand = New SqlDataAdapter("ProjectSumBusiness", MyConnection)
            MyCommand.SelectCommand.CommandType = CommandType.StoredProcedure
        ...
        Sub SubmitBtn_Click(ByVal sender As Object, ByVal e As System.EventArgs)
            ...
            Response.Redirect("ReportbyBusinessExcel.aspx?Business=" & RequestedBusiness & "&YearField=" & SelectedYear & "&StageField=" & SelectedStage)
        End Sub
