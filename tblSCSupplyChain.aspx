<%@ Page Language="vb" AutoEventWireup="false" Inherits="SCLE.Admin.tblSCSupplyChain" CodeFile="tblSCSupplyChain.aspx.vb" %>
<HTML>
	<body>
		<center>
				...
				<asp:datagrid id="datagrid1" runat="server" Font-Size="8pt" Font-Name="verdana" Cellpadding="3"
					...
					<Columns>
						<asp:TemplateColumn HeaderText="Sub GBU">
							...
							<FooterTemplate>
								<asp:TextBox id="SupplyChain_Add" runat="server" Columns="20" />
							</FooterTemplate>
							<EditItemTemplate>
								<asp:Textbox runat="server" Columns="20" id="SupplyChain_edit" Text='<%# DataBinder.Eval(Container.DataItem,"value") %>' />
							</EditItemTemplate>
						</asp:TemplateColumn>
