<%@ Page Language="vb" AutoEventWireup="false" Inherits="SCLE.Admin.tblStatus" CodeFile="tblStatus.aspx.vb" %>
<HTML>
	<HEAD>
		<title>status</title>
		...
		<center>
			<form runat="server" ID="Form1">
				...
				<asp:datagrid id="datagrid1" runat="server" Font-Size="8pt" Font-Name="verdana" Cellpadding="3"
					...
					onDeleteCommand="delXML" ShowFooter="True" DataKeyField="Status" onItemCommand="doInsert"
					...
					<Columns>
						<asp:TemplateColumn HeaderText="Sub GBU">
							...
							<FooterTemplate>
								<asp:TextBox id="tblStatus_Add" runat="server" Columns="20" />
							</FooterTemplate>
							<EditItemTemplate>
								<asp:Textbox runat="server" Columns="20" id="tblStatus_edit" Text='<%# DataBinder.Eval(Container.DataItem,"Status") %>' />
							</EditItemTemplate>
						</asp:TemplateColumn>
