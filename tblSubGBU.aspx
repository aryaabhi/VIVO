<%@ Page Language="vb" AutoEventWireup="false" Inherits="SCLE.Admin.tblSubGBU" CodeFile="tblSubGBU.aspx.vb" %>
<HTML>
	<body>
		<center>
			<form runat="server" ID="Form1">
				<h3>Manage Sub GBU</h3>
				<asp:datagrid id="datagrid1" runat="server" Font-Size="8pt" Font-Name="verdana" Cellpadding="3"
					...
					<Columns>
						<asp:TemplateColumn HeaderText="Sub GBU">
							...
							<EditItemTemplate>
								<asp:Textbox runat="server" Columns="20" id="SubGBU_edit" Text='<%# DataBinder.Eval(Container.DataItem,"value") %>' />
							</EditItemTemplate>
						</asp:TemplateColumn>
