...
Namespace SCLE.User
    Partial Class ReportSummaryMonthlyPlantExcel
...
#End Region
        ...
        Sub Page_Load(ByVal Src As Object, ByVal E As EventArgs) Handles MyBase.Load
            ...
            Response.AddHeader("Content-Disposition", "inline;filename=MonthlyPlantSummary.xls")
        ...
        Sub ShowBPEGrid()
            MyCommand = New SqlDataAdapter("SummaryMonthlyPlant", MyConnection)
