<%@ Page Language="vb" AutoEventWireup="false" Inherits="SCLE.User.ReportSummaryMonthlyPlantExcel" CodeFile="ReportSummaryMonthlyPlantExcel.aspx.vb" %>
<HTML>
	<HEAD>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<table border="1" cellpadding="0" cellspacing="0" style="BORDER-COLLAPSE: collapse" bordercolor="#111111"
				...
				<tr>
					<td width="100%" class="heading" align="center" bgcolor="#33cc33">IN BPE 
						-&nbsp;PLANT SUMMARY</td>
				</tr>
				<tr>
