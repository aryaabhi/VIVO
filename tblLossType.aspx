<%@ Page Language="vb" AutoEventWireup="false" Inherits="SCLE.Admin.tblLossType" CodeFile="tblLossType.aspx.vb" %>
<HTML>
	<body>
		<center>
			<form runat="server" ID="Form1">
				<h3>Manage Loss Type</h3>
				<asp:datagrid id="datagrid1" runat="server" Font-Size="8pt" Font-Name="verdana" Cellpadding="3"
					...
					onDeleteCommand="delXML" ShowFooter="True" DataKeyField="LossType" onItemCommand="doInsert"
					BackColor="#ccccff" Font-Names="verdana" BorderStyle="None" CellSpacing="2">
					...
					<Columns>
						<asp:TemplateColumn HeaderText="Sub GBU">
							<ItemTemplate>
								<%# DataBinder.Eval(Container.DataItem,"LossType") %>
							</ItemTemplate>
							<FooterTemplate>
								<asp:TextBox id="tblLossType_Add" runat="server" Columns="20" />
							</FooterTemplate>
							<EditItemTemplate>
								<asp:Textbox runat="server" Columns="20" id="tblLossType_edit" Text='<%# DataBinder.Eval(Container.DataItem,"LossType") %>' />
							</EditItemTemplate>
						</asp:TemplateColumn>
