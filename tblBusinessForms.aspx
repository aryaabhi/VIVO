			...
			<form runat="server" ID="Form1">
				...
				<asp:DataGrid id="datagrid2" runat="server" Font-Size="8pt" AutoGenerateColumns="False" Font-Name="verdana"
					...
					<HeaderStyle font-size="8pt" font-names="Arial" font-bold="True" horizontalalign="Center" forecolor="White"
						backcolor="#3399cc"></HeaderStyle>
					<Columns>
						<asp:BoundColumn HeaderText="SubGBU" SortExpression="SubGBU" DataField="SubGBU"></asp:BoundColumn>
						<asp:BoundColumn HeaderText="Business Available for reference" SortExpression="value" DataField="value"></asp:BoundColumn>
					</Columns>
				</asp:DataGrid>
