...
Public Class vMfgCode
    Inherits System.Web.UI.Page
    Dim Viv As New VivoClass
    Public TableName As String = "MfgCode"
    ...
    Private Sub BindData()
        'If Session("Sort") = "" Then Session("Sort") = "MfgCodeID"
        'GridView1.DataSource = Viv.BindData("MfgCode", Session("Sort"))
        GridView1.DataSource = Viv.BindData("MfgCode", "MfgCodeID")
        GridView1.DataBind()
    End Sub
    ...
    Protected Sub AddRecord(ByVal sender As Object, ByVal e As EventArgs)
        ...
        GridView1.DataSource = Viv.Insert("", Field2, "", "MfgCode")
        GridView1.DataBind()
    End Sub
    ...
    Protected Sub UpdateRecord(ByVal sender As Object, ByVal e As GridViewUpdateEventArgs)
        ...
        GridView1.EditIndex = -1
        GridView1.DataSource = Viv.Update(Field1, Field2, "", "MfgCode")
        GridView1.DataBind()
    End Sub

    Protected Sub DeleteRecord(ByVal sender As Object, ByVal e As EventArgs)
        Dim lnkRemove As LinkButton = DirectCast(sender, LinkButton)
        GridView1.DataSource = Viv.Delete(lnkRemove.CommandArgument, "", "", "MfgCode")
        GridView1.DataBind()
    End Sub
