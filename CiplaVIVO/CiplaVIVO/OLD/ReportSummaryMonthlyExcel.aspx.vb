...
Namespace SCLE.User
    Partial Class ReportSummaryMonthlyExcel
...
#End Region
        ...
        Sub Page_Load(ByVal Src As Object, ByVal E As EventArgs) Handles MyBase.Load
            ...
            Response.AddHeader("Content-Disposition", "inline;filename=MonthlySummary.xls")
        ...
        Sub ShowBPEGrid()
            MyCommand = New SqlDataAdapter("SummaryMonthlyBusiness", MyConnection)
