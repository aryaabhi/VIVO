<%@ Page Language="vb" AutoEventWireup="false" Inherits="SCLE.User.ReportByPillars" CodeFile="ReportByPillars.aspx.vb" %>
<HTML>
	<HEAD>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<asp:datagrid id="ProjectDataGrid" OnItemDataBound="ProjectDataGrid_ItemDataBound" runat="server"
				...
				HeaderStyle-ForeColor="#ffffff" EnableViewState="True" AutoGenerateColumns="False" AlternatingItemStyle-BackColor="#ffffff">
				<Columns>
			...
			<asp:datagrid id="SumDataGrid" runat="server" BackColor="#ccccff" BorderColor="black" CellPadding="3"
				CellSpacing="0" Font-Name="Verdana" Font-Size="8pt" HeaderStyle-BackColor="#aaaadd" EnableViewState="false"></asp:datagrid>
		</form>
	</body>
</HTML>
