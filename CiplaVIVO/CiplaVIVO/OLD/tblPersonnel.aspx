<%@ Page Language="vb" AutoEventWireup="false" Inherits="SCLE.Admin.tblPersonnel" CodeFile="tblPersonnel.aspx.vb" %>
<HTML>
	<body>
		<center>
			<form runat="server" ID="Form1">
				<h3>Manage TDC SubElements</h3>
				<asp:datagrid id="datagrid1" runat="server" Font-Size="8pt" Font-Name="verdana" Cellpadding="3"
					...
					onDeleteCommand="delXML" ShowFooter="True" DataKeyField="PersonnelID" onItemCommand="doInsert" BackColor="#ccccff"
					...
					<Columns>
						<asp:TemplateColumn HeaderText="Personnel ID">
							<ItemTemplate>
								<%# DataBinder.Eval(Container.DataItem,"PersonnelID") %>
							</ItemTemplate>
							<FooterTemplate>
								<asp:TextBox id="PersonnelID_Add" runat="server" Columns="20" />
							</FooterTemplate>
							<EditItemTemplate>
								<asp:Textbox runat="server" Columns="20" id="PersonnelID_edit" Text='<%# DataBinder.Eval(Container.DataItem,"PersonnelID") %>' />
							</EditItemTemplate>
						</asp:TemplateColumn>
						<asp:TemplateColumn HeaderText="Name">
							...
							<FooterTemplate>
								<asp:TextBox id="Name_add" runat="server" Columns="10" />
							</FooterTemplate>
							<EditItemTemplate>
								<asp:Textbox runat="server" Columns="15" id="Name_edit" Text='<%# DataBinder.Eval(Container.DataItem,"Name") %>' />
							</EditItemTemplate>
						</asp:TemplateColumn>
