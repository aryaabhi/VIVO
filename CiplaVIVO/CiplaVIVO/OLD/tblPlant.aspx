<%@ Page Language="vb" AutoEventWireup="false" Inherits="SCLE.Admin.tblPlant" CodeFile="tblPlant.aspx.vb" %>
<HTML>
	<body>
		<center>
			<form runat="server" ID="Form1">
				...
				<asp:datagrid id="datagrid1" runat="server" Font-Size="8pt" Font-Name="verdana" Cellpadding="3"
					...
					onDeleteCommand="delXML" ShowFooter="True" DataKeyField="PlantDesc" onItemCommand="doInsert"
					...
					<Columns>
						...
						<asp:TemplateColumn HeaderText="Business">
							<ItemTemplate>
								<%# DataBinder.Eval(Container.DataItem,"PlantDesc") %>
							</ItemTemplate>
							<FooterTemplate>
								<asp:TextBox id="Plant_add" runat="server" Columns="10" />
							</FooterTemplate>
							<EditItemTemplate>
								<asp:Textbox runat="server" Columns="15" id="Plant_edit" Text='<%# DataBinder.Eval(Container.DataItem,"PlantDesc") %>' />
							</EditItemTemplate>
						</asp:TemplateColumn>
