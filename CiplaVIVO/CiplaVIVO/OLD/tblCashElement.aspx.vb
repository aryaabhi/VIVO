...
#End Region
        ...
        Sub LoadXML()
            ...
            objdata.ReadXml(Server.MapPath("tblCASHElement.xml"))
        ...
        Sub setEditMode(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
            ...
            objdata.Tables("CASHElement").DefaultView.RowFilter = "value='" & x1 & "'"
            If objdata.Tables("CASHElement").DefaultView.Count > 0 Then
        ...
        Sub DelXML(ByVal S As Object, ByVal E As DataGridCommandEventArgs)
            If E.CommandName = "Delete" Then
                If datagrid1.EditItemIndex = -1 Then
                    ...
                    objdata.Tables("CASHElement").DefaultView.RowFilter = "value='" & x1 & "'"
                    If objdata.Tables("CASHElement").DefaultView.Count > 0 Then
                        objdata.Tables("CASHElement").DefaultView.Delete(0)
                    End If
                    objdata.Tables("CASHElement").DefaultView.RowFilter = ""

                    objdata.WriteXml(Server.MapPath("tblCASHElement.xml"))
                    LoadXML()
                Else
                    error5.Visible = "True"
                End If
        ...
        Sub UpdateXML(ByVal s As Object, ByVal e As DataGridCommandEventArgs)
            If e.CommandName = "Update" Then
                ...
                If objdata.Tables("CASHElement").DefaultView.Count > 0 Then
                    ...
                    objdata.Tables("CASHElement").Rows(v1).Item("value") = txt1.Text
                    datagrid1.DataSource = objdata
                    datagrid1.DataBind()
        ...
        Sub doInsert(ByVal s As Object, ByVal E As DataGridCommandEventArgs)
            ...
            If E.CommandName = "doAdd" Then
                ...
                If tadd1.Text <> "" Then
                    objdata.Tables("CASHElement").DefaultView.RowFilter = ""
                    dr = objdata.Tables("CASHElement").NewRow()
                    dr(0) = tadd1.Text
                    objdata.Tables("CASHElement").Rows.Add(dr)
                    objdata.WriteXml(Server.MapPath("tblCASHElement.xml"))
                    LoadXML()
                End If
            End If
