...
Namespace SCLE.User
    Partial Class ReportByTDCElement
...
#End Region
        ...
        Dim RequestedTDCElement As String
        ...
        Sub Page_Load(ByVal Src As Object, ByVal E As EventArgs) Handles MyBase.Load
            ...
            RequestedTDCElement = Request.QueryString("TDCElement")
        ...
        Sub Year_Refresh_Display()
            If cboYear.SelectedItem.Value = "" Then
                ...
                End If
                HeaderLabel.Text = "Project List for " & RequestedTDCElement & " Year " & SelectedYear & "-" & Right(SelectedYear + 1, 2)
            Else
                SelectedYear = cboYear.SelectedItem.Value
                HeaderLabel.Text = "Project List for " & RequestedTDCElement & " Year " & cboYear.SelectedItem.Text
            End If
        ...
        Sub ShowDataGrid()
            MyCommand = New SqlDataAdapter("ProjectsSelectTDCElement", MyConnection)
            ...
            MyCommand.SelectCommand.Parameters.Add(New SqlParameter("@TDCElement", SqlDbType.Char, 20))
            MyCommand.SelectCommand.Parameters("@TDCElement").Value = RequestedTDCElement
        ...
        Sub ShowSumGrid()
            MyCommand = New SqlDataAdapter("ProjectSumTDCElement", MyConnection)
            MyCommand.SelectCommand.CommandType = CommandType.StoredProcedure
        ...
        Sub SubmitBtn_Click(ByVal sender As Object, ByVal e As System.EventArgs)
            ...
            Response.Redirect("ReportByTDCElementExcel.aspx?TDCElement=" & RequestedTDCElement & "&YearField=" & SelectedYear & "&StageField=" & SelectedStage)
        End Sub
