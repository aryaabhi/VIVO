<%@ Page Language="vb" AutoEventWireup="false" Inherits="SCLE.Admin.tblYears" CodeFile="tblYears.aspx.vb" %>
<HTML>
	<body>
		<center>
			<form runat="server" ID="Form1">
				...
				<asp:datagrid id="datagrid1" runat="server" Font-Size="8pt" Font-Name="verdana" Cellpadding="3"
					...
					onDeleteCommand="delXML" ShowFooter="True" DataKeyField="YearInteger" onItemCommand="doInsert"
					...
					<Columns>
						<asp:TemplateColumn HeaderText="Sub GBU">
							<ItemTemplate>
								<%# DataBinder.Eval(Container.DataItem,"YearInteger") %>
							</ItemTemplate>
							<FooterTemplate>
								<asp:TextBox id="tblYears_Add" runat="server" Columns="20" />
							</FooterTemplate>
							<EditItemTemplate>
								<asp:Textbox runat="server" Columns="20" id="tblYears_edit" Text='<%# DataBinder.Eval(Container.DataItem,"YearInteger") %>' />
							</EditItemTemplate>
						</asp:TemplateColumn>
