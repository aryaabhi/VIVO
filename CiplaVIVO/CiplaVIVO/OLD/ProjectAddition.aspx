	...
	<div class="container">
        ...
        <div class="mp-pusher" id="mp-pusher">
            ...
            <div class="scroller">
				...
				<div>
					<label>Sub GBU:</lable>
					<asp:dropdownlist id="cboCategory" runat="server" Class="txtBox" DataValueField="value" DataTextField="value"/>
					<label>Plant / Location:</label>
					<asp:dropdownlist id="cboPlant" runat="server" Class="txtBox" DataValueField="PlantDesc" DataTextField="PlantDesc"/>
				</div>
				<div>
					<label>Business(Brand):</label>
					<asp:dropdownlist id="cboBusiness" runat="server" Class="txtBox" DataValueField="value"
					DataTextField="value" OnSelectedIndexChanged="Business_AfterUpdate" AutoPostBack="True"/>
					<label>Business Form:</label>
					<asp:dropdownlist id="cboBusinessForm" runat="server" Class="txtBox" DataValueField="value" DataTextField="value"/>
					<label>Organizations:</label>
					<asp:dropdownlist id="cboOtherBusiness" runat="server" Class="txtBox" DataValueField="value" DataTextField="value"/>
				</div>
				<div>
					<label>Project Name:</label>
					<asp:textbox id="txtProjectName" runat="server" Class="txtbox"/>
					<label>Project Leader:</label>
					<asp:dropdownlist id="cboProjectLeader" runat="server" Class="txtBox" DataValueField="PersonnelID" DataTextField="Name"/>
				</div>
				<div>
					<label>Project Begins:</label>
					<label>Month:</label>
					<asp:dropdownlist id="cboProjectStartMonth" runat="server" Class="txtBox" DataValueField="MonthInteger" DataTextField="MonthLiteral" OnSelectedIndexChanged="ProjectMonth_AfterUpdate" AutoPostBack="True"/>
					<label>Year:</label>
					<asp:dropdownlist id="cboProjectStartYear" runat="server" Class="txtBox" DataValueField="YearInteger" DataTextField="YearInteger" OnSelectedIndexChanged="ProjectYear_AfterUpdate" AutoPostBack="True"/>
					<label>Savings Begin:</label>
					<label>Month:</label>
					<asp:dropdownlist id="cboSavingsStartMonth" runat="server" Class="txtBox" DataValueField="MonthInteger" DataTextField="MonthLiteral"/>
					<label>Year:</label>
					<asp:dropdownlist id="cboSavingsStartYear" runat="server" Class="txtBox" DataValueField="YearInteger" DataTextField="YearInteger"/>
				</div>
				<div>
					<label>Status:</label>
				...
				<div>
					...
					<asp:dropdownlist id="cboCostBucket" runat="server" DataTextField="value" DataValueField="value" Class="txtBox" AutoPostBack="True" OnSelectedIndexChanged="TDCElement_AfterUpdate"/>
				...
				<div>
					...
					<asp:textbox id="AccountingMonth" runat="server" Class="txtBox" ReadOnly="True"/>/
					<asp:textbox id="AccountingYear" runat="server" Class="txtBox" ReadOnly="True"/>
				</div>
				<div>
					...
					<asp:textbox id="txtProbabilityAdjustedAmt" runat="server" Class="txtBox" ReadOnly="True"/>
				</div>
				<div>
					...
					<asp:textbox id="txtTimeAdjustedAmount" runat="server" Class="txtBox" ReadOnly="True"/>
				</div>
				<div>
					<label>Total (Time &amp; Prob.) Adjusted Amount (in $M):</label>
					<asp:textbox id="txtTotalAdjustedAmount" runat="server" Class="txtBox" ReadOnly="True"/>
				</div>
				<div>
			...
			<asp:panel id="CashPanel" Runat="server" Visible="False">
				...
				<div>
					...
					<asp:dropdownlist id="cboCashElement" runat="server" DataTextField="value" DataValueField="value" Class="txtBox" AutoPostBack="True" OnSelectedIndexChanged="CashElement_AfterUpdate"/>
				</div>
				<div>
				...
				<div>
					...
					<label>Probability Adjusted Amount (in $M):</label>
					<asp:textbox id="txtCashAdjAmt" runat="server" Class="txtBox" ReadOnly="True">0</asp:textbox>
				</div>
				<div>
					<label>Additional Comments/Notes:</label>
			...
			<asp:panel id="CustomerPanel" Runat="server" Visible="False">
				...
				<div>
					...
					<asp:textbox id="txtCVCPGSavings" tabIndex="39" runat="server" Class="txtBox" BackColor="White">0</asp:textbox>
				...
				<div>
					...
					<asp:textbox id="txtCVCProbAdjAmt" runat="server" Class="txtBox" ReadOnly="True">0</asp:textbox>
				</div>
				<div>
					<label>Additional Comments/Notes:</label>
			...
			<asp:panel id="SupplyChainTimePanel" Runat="server" Visible="False">
				...
				<div>
					...
					<asp:textbox id="txtSCImpact" runat="server" Class="txtBox" ReadOnly="True">0</asp:textbox>
				</div>
				<div>
					<label>Probability:</label>
				...
				<div>
					...
					<asp:dropdownlist id="cboLossType" runat="server" Class="txtBox" DataValueField="LossType" DataTextField="LossType"/><A href="javascript:popUp('LossType.aspx')"></A>
					<label>Department</label>
					<asp:dropdownlist id="cboDepartment" runat="server" Class="txtBox" DataValueField="Value" DataTextField="Value"/>
				</div>
				<div>
