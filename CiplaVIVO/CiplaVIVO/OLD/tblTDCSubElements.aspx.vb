...
Namespace SCLE.Admin
    ...
    Partial Class tblTDCSubElements
...
#End Region
        ...
        Sub LoadXML()
            ...
            objdata.ReadXml(Server.MapPath("tblTDCSubElements.xml"))
            datagrid1.DataSource = objdata
            datagrid1.DataBind()

            Dim myDataSet As New DataSet
            myDataSet.ReadXml(Server.MapPath("tblTDCElements.xml"))
            datagrid2.DataSource = myDataSet.Tables("TDCElement").DefaultView
            datagrid2.DataBind()
        End Sub
        ...
        Sub setEditMode(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
            ...
            objdata.Tables("TDCSubElement").DefaultView.RowFilter = "value='" & x1 & "'"
            If objdata.Tables("TDCSubElement").DefaultView.Count > 0 Then
        ...
        Sub DelXML(ByVal S As Object, ByVal E As DataGridCommandEventArgs)
            If E.CommandName = "Delete" Then
                If datagrid1.EditItemIndex = -1 Then
                    ...
                    objdata.Tables("TDCSubElement").DefaultView.RowFilter = "value='" & x1 & "'"
                    If objdata.Tables("TDCSubElement").DefaultView.Count > 0 Then
                        objdata.Tables("TDCSubElement").DefaultView.Delete(0)
                    End If
                    objdata.Tables("TDCSubElement").DefaultView.RowFilter = ""

                    objdata.WriteXml(Server.MapPath("tblTDCSubElements.xml"))
                    LoadXML()
                Else
                    error5.Visible = "True"
                End If
        ...
        Sub UpdateXML(ByVal s As Object, ByVal e As DataGridCommandEventArgs)
            If e.CommandName = "Update" Then
                ...
                If objdata.Tables("TDCSubElement").DefaultView.Count > 0 Then
                    ...
                    objdata.Tables("TDCSubElement").Rows(v1).Item("TDCElement") = txt1.Text
                    objdata.Tables("TDCSubElement").Rows(v1).Item("value") = txt2.Text
                    datagrid1.DataSource = objdata
                    datagrid1.DataBind()
        ...
        Sub doInsert(ByVal s As Object, ByVal E As DataGridCommandEventArgs)
            ...
            If E.CommandName = "doAdd" Then
                ...
                If tadd1.Text <> "" And tadd2.Text <> "" Then
                    objdata.Tables("TDCSubElement").DefaultView.RowFilter = ""
                    dr = objdata.Tables("TDCSubElement").NewRow()
                    dr(0) = tadd1.Text
                    dr(1) = tadd2.Text
                    objdata.Tables("TDCSubElement").Rows.Add(dr)
                    objdata.WriteXml(Server.MapPath("tblTDCSubElements.xml"))
                    LoadXML()
                End If
            End If
