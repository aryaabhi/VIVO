<%@ Page Language="vb" AutoEventWireup="false" Inherits="SCLE.Admin.tblCashElement" CodeFile="tblCashElement.aspx.vb" %>
<HTML>
	<body>
		<center>
			<form runat="server" ID="Form1">
				<h3>Manage Cash Element</h3>
				<asp:datagrid id="datagrid1" runat="server" Font-Size="8pt" Font-Name="verdana" Cellpadding="3"
					...
					<Columns>
						<asp:TemplateColumn HeaderText="Sub GBU">
							...
							<EditItemTemplate>
								<asp:Textbox runat="server" Columns="20" id="CASHElement_edit" Text='<%# DataBinder.Eval(Container.DataItem,"value") %>' />
							</EditItemTemplate>
						</asp:TemplateColumn>
