...
#End Region
        ...
        Sub LoadXML()
            ...
            objdata.ReadXml(Server.MapPath("tblSubGBU.xml"))
        ...
        Sub setEditMode(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
            ...
            objdata.Tables("SubGBU").DefaultView.RowFilter = "value='" & x1 & "'"
            If objdata.Tables("SubGBU").DefaultView.Count > 0 Then
        ...
        Sub DelXML(ByVal S As Object, ByVal E As DataGridCommandEventArgs)
            If E.CommandName = "Delete" Then
                If datagrid1.EditItemIndex = -1 Then
                    ...
                    objdata.Tables("SubGBU").DefaultView.RowFilter = "value='" & x1 & "'"
                    If objdata.Tables("SubGBU").DefaultView.Count > 0 Then
                        objdata.Tables("SubGBU").DefaultView.Delete(0)
                    End If
                    objdata.Tables("SubGBU").DefaultView.RowFilter = ""

                    objdata.WriteXml(Server.MapPath("tblSubGBU.xml"))
                    LoadXML()
                Else
                    error5.Visible = "True"
                End If
        ...
        Sub UpdateXML(ByVal s As Object, ByVal e As DataGridCommandEventArgs)
            If e.CommandName = "Update" Then
                ...
                If objdata.Tables("SubGBU").DefaultView.Count > 0 Then
                    ...
                    objdata.Tables("SubGBU").Rows(v1).Item("value") = txt1.Text
                    datagrid1.DataSource = objdata
                    datagrid1.DataBind()
        ...
        Sub doInsert(ByVal s As Object, ByVal E As DataGridCommandEventArgs)
            ...
            If E.CommandName = "doAdd" Then
                ...
                If tadd1.Text <> "" Then
                    objdata.Tables("SubGBU").DefaultView.RowFilter = ""
                    dr = objdata.Tables("SubGBU").NewRow()
                    dr(0) = tadd1.Text
                    objdata.Tables("SubGBU").Rows.Add(dr)
                    objdata.WriteXml(Server.MapPath("tblSubGBU.xml"))
                    LoadXML()
                End If
            End If
