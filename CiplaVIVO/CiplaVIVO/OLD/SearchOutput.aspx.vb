...
#End Region
        ...
        Sub ShowSumGrid()
            ...
            '	objCommand = New OleDbCommand(SumText, objConnection)
            '	objConnection.Open()
            '
            '	objDataReader = objCommand.ExecuteReader(CommandBehavior.CloseConnection)
            '   We've got our data... now connect it to our list:
            '
            '	SumDataGrid.DataSource = objDataReader
        ...
        Sub SubmitBtn_Click(ByVal sender As Object, ByVal e As System.EventArgs)
            Response.Redirect("searchoutputexcel.aspx?ReportID=" & reportId)
        End Sub
        ...
        Sub DataGrid1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
