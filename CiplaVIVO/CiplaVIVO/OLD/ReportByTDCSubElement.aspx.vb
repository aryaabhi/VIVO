...
Namespace SCLE.User
    Partial Class ReportByTDCSubElement
...
#End Region
        ...
        Dim RequestedTDCSubElement As String
        ...
        Sub Page_Load(ByVal Src As Object, ByVal E As EventArgs) Handles MyBase.Load
            ...
            RequestedTDCSubElement = Request.QueryString("TDCSubElement")
        ...
        Sub Year_Refresh_Display()
            If cboYear.SelectedItem.Value = "" Then
                ...
                End If
                HeaderLabel.Text = "Project List for " & RequestedTDCSubElement & " Year " & SelectedYear & "-" & Right(SelectedYear + 1, 2)
            Else
                SelectedYear = cboYear.SelectedItem.Value
                HeaderLabel.Text = "Project List for " & RequestedTDCSubElement & " Year " & cboYear.SelectedItem.Text
            End If
        ...
        Sub ShowDataGrid()
            MyCommand = New SqlDataAdapter("ProjectsSelectTDCSubElement", MyConnection)
            ...
            MyCommand.SelectCommand.Parameters.Add(New SqlParameter("@TDCSubElement", SqlDbType.Char, 20))
            MyCommand.SelectCommand.Parameters("@TDCSubElement").Value = RequestedTDCSubElement

            MyCommand.SelectCommand.Parameters.Add(New SqlParameter("@ProjectStage", SqlDbType.NVarChar, 50))
            MyCommand.SelectCommand.Parameters("@ProjectStage").Value = DropDownList1.SelectedItem.Value

            MyCommand.SelectCommand.Parameters.Add(New SqlParameter("@sortColumn", SqlDbType.Char, 20))
            MyCommand.SelectCommand.Parameters("@sortColumn").Value = SelectedSort
        ...
        Sub ShowSumGrid()
            MyCommand = New SqlDataAdapter("ProjectSumTDCSubElement", MyConnection)
            MyCommand.SelectCommand.CommandType = CommandType.StoredProcedure
        ...
        Sub SubmitBtn_Click(ByVal sender As Object, ByVal e As System.EventArgs)
            ...
            Response.Redirect("ReportByTDCSubElementExcel.aspx?TDCSubElement=" & RequestedTDCSubElement & "&YearField=" & SelectedYear & "&StageField=" & SelectedStage)
        End Sub
