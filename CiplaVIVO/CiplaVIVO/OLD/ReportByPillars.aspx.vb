...
#End Region
        ...
        Sub Year_Refresh_Display()
            If cboYear.SelectedItem.Value = "" Then
                ...
                End If
                HeaderLabel.Text = "Project List for Organization " & RequestedPillar & " Year " & SelectedYear & "-" & Right(SelectedYear + 1, 2)
            Else

                SelectedYear = cboYear.SelectedItem.Value
                HeaderLabel.Text = "Project List for " & RequestedPillar & " Year " & cboYear.SelectedItem.Text
            End If
        ...
        Sub ShowSumGrid()
            MyCommand = New SqlDataAdapter("ProjectSumPillars", MyConnection)
            MyCommand.SelectCommand.CommandType = CommandType.StoredProcedure
        ...
        Sub SubmitBtn_Click(ByVal sender As Object, ByVal e As System.EventArgs)
            ...
            Response.Redirect("ReportByPillarsExcel.aspx?TDCElement=" & RequestedPillar & "&YearField=" & SelectedYear & "&StageField=" & SelectedStage)
        End Sub
        ...
        Sub SortData(ByVal sender As Object, ByVal e As DataGridSortCommandEventArgs) Handles ProjectDataGrid.SortCommand
