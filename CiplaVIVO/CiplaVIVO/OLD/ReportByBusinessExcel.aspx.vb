...
Namespace SCLE.User
    Partial Class ReportbyBusinessExcel
...
#End Region
        ...
        Sub Page_Load(ByVal Src As Object, ByVal E As EventArgs) Handles MyBase.Load
            ...
            Response.AddHeader("Content-Disposition", "inline;filename=BusinessReport.xls")
            ...
            HeaderLabel.Text = "Project List for " & RequestedBusiness & " Year " & SelectedYear & "-" & SelectedYear + 1
            ShowDataGrid()
            '	ShowSumGrid()
