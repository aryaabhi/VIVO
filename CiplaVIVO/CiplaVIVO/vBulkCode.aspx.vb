...
Public Class vBulkCode
    Inherits System.Web.UI.Page
    Dim Viv As New VivoClass
    Public TableName As String = "BulkCode"
    ...
    Private Sub BindData()
        'If Session("Sort") = "" Then Session("Sort") = "BulkCodeID"
        'GridView1.DataSource = Viv.BindData("BulkCode", Session("Sort"))
        GridView1.DataSource = Viv.BindData("BulkCode", "BulkCodeID")
        GridView1.DataBind()
    End Sub
    ...
    Protected Sub AddRecord(ByVal sender As Object, ByVal e As EventArgs)
        ...
        GridView1.DataSource = Viv.Insert("", Field2, "", "BulkCode")
        GridView1.DataBind()
    End Sub
    ...
    Protected Sub UpdateRecord(ByVal sender As Object, ByVal e As GridViewUpdateEventArgs)
        ...
        GridView1.EditIndex = -1
        GridView1.DataSource = Viv.Update(Field1, Field2, "", "BulkCode")
        GridView1.DataBind()
    End Sub

    Protected Sub DeleteRecord(ByVal sender As Object, ByVal e As EventArgs)
        Dim lnkRemove As LinkButton = DirectCast(sender, LinkButton)
        GridView1.DataSource = Viv.Delete(lnkRemove.CommandArgument, "", "", "BulkCode")
        GridView1.DataBind()
    End Sub
