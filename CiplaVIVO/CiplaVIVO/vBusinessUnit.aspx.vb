...
Public Class vBusinessUnit
    ...
    Public TableName As String = "BusinessUnit"
    ...
    Private Sub BindData()
        'If Session("Sort") = "" Then Session("Sort") = "BusinessUnitID"
        'GridView1.DataSource = Viv.BindData("BusinessUnit", Session("Sort"))
        GridView1.DataSource = Viv.BindData("BusinessUnit", "BusinessUnitID")
        GridView1.DataBind()
    End Sub
    ...
    Protected Sub AddRecord(ByVal sender As Object, ByVal e As EventArgs)
        ...
        GridView1.DataSource = Viv.Insert("", Field2, "", "BusinessUnit")
        GridView1.DataBind()
    End Sub
    ...
    Protected Sub UpdateRecord(ByVal sender As Object, ByVal e As GridViewUpdateEventArgs)
        ...
        GridView1.EditIndex = -1
        GridView1.DataSource = Viv.Update(Field1, Field2, "", "BusinessUnit")
        GridView1.DataBind()
    End Sub

    Protected Sub DeleteRecord(ByVal sender As Object, ByVal e As EventArgs)
        Dim lnkRemove As LinkButton = DirectCast(sender, LinkButton)
        GridView1.DataSource = Viv.Delete(lnkRemove.CommandArgument, "", "", "BusinessUnit")
        GridView1.DataBind()
    End Sub
