<%@ Page Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="vTherapy.aspx.vb" Inherits="CiplaVIVO.vTherapy" %>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowSorting="true" OnSorting="SortData"
                            ...
                            PageSize = "10" >
    			    <Columns>
					    <asp:TemplateField HeaderText = "TherapyID" SortExpression="TherapyID" ItemStyle-CssClass="hidden-phone" HeaderStyle-CssClass="hidden-phone" FooterStyle-CssClass="hidden-phone">
					        <ItemTemplate>
					            <asp:Label ID="txtField1" runat="server"
					            Text='<%# Eval("TherapyID")%>'></asp:Label>
					        </ItemTemplate>
					        <FooterTemplate>
					    ...
					    <asp:TemplateField HeaderText = "Therapy" SortExpression="Therapy" FooterStyle-CssClass="hidden-phone">
					        <ItemTemplate>
					            <asp:Label ID="txtField2" runat="server" Text='<%# Eval("Therapy")%>'></asp:Label>
					        </ItemTemplate>
					        <EditItemTemplate>
					            <asp:TextBox ID="txtField2" runat="server" Text='<%# Eval("Therapy")%>'></asp:TextBox>
					        </EditItemTemplate> 
					        <FooterTemplate>
					    ...
					    <asp:TemplateField ItemStyle-CssClass="hidden-phone" HeaderStyle-CssClass="hidden-phone" FooterStyle-CssClass="hidden-phone">
					        <ItemTemplate>
					            <asp:LinkButton ID="lnkRemove" runat="server"
					                CommandArgument = '<%# Eval("TherapyID")%>'
