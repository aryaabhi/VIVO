...
Public Class vCurrency
    ...
    Public TableName As String = "Currency"
    ...
    Private Sub BindData()
        'If Session("Sort") = "" Then Session("Sort") = "CurrencyID"
        'GridView1.DataSource = Viv.BindData("Currency", Session("Sort"))
        GridView1.DataSource = Viv.BindData("Currency", "CurrencyID")
        GridView1.DataBind()
    End Sub
    ...
    Protected Sub AddRecord(ByVal sender As Object, ByVal e As EventArgs)
        ...
        GridView1.DataSource = Viv.Insert("", Field2, "", "Currency")
        GridView1.DataBind()
    End Sub
    ...
    Protected Sub UpdateRecord(ByVal sender As Object, ByVal e As GridViewUpdateEventArgs)
        ...
        GridView1.EditIndex = -1
        GridView1.DataSource = Viv.Update(Field1, Field2, "", "Currency")
        GridView1.DataBind()
    End Sub

    Protected Sub DeleteRecord(ByVal sender As Object, ByVal e As EventArgs)
        Dim lnkRemove As LinkButton = DirectCast(sender, LinkButton)
        GridView1.DataSource = Viv.Delete(lnkRemove.CommandArgument, "", "", "Currency")
        GridView1.DataBind()
    End Sub
