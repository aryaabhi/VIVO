<%@ Page Language="vb" AutoEventWireup="false" Inherits="SCLE.Admin.tblDepartment" CodeFile="tblDepartment.aspx.vb" %>
<HTML>
	<body>
		<center>
				...
				<asp:datagrid id="datagrid1" runat="server" Font-Size="8pt" Font-Name="verdana" Cellpadding="3"
					...
					<Columns>
						<asp:TemplateColumn HeaderText="Sub GBU">
							...
							<FooterTemplate>
								<asp:TextBox id="Department_Add" runat="server" Columns="20" />
							</FooterTemplate>
							<EditItemTemplate>
								<asp:Textbox runat="server" Columns="20" id="Department_edit" Text='<%# DataBinder.Eval(Container.DataItem,"value") %>' />
							</EditItemTemplate>
						</asp:TemplateColumn>
