<%@ Page Language="vb" AutoEventWireup="false" Inherits="SCLE.Admin.tblCashSubElement" CodeFile="tblCashSubElement.aspx.vb" %>
<HTML>
	<body>
		<center>
			<form runat="server" ID="Form1">
				<h3>Manage Cash Sub Element</h3>
				<asp:datagrid id="datagrid1" runat="server" Font-Size="8pt" Font-Name="verdana" Cellpadding="3"
					...
					<Columns>
						<asp:TemplateColumn HeaderText="Sub GBU">
							<ItemTemplate>
								<%# DataBinder.Eval(Container.DataItem,"CASHElement") %>
							</ItemTemplate>
							<FooterTemplate>
								<asp:TextBox id="CASHElement_Add" runat="server" Columns="20" />
							</FooterTemplate>
							<EditItemTemplate>
								<asp:Textbox runat="server" Columns="20" id="CASHElement_edit" Text='<%# DataBinder.Eval(Container.DataItem,"CASHElement") %>' />
							</EditItemTemplate>
						</asp:TemplateColumn>
