<%@ Page Language="vb" AutoEventWireup="false" Inherits="SCLE.Admin.tblOtherBusiness" CodeFile="tblOtherBusiness.aspx.vb" %>
<HTML>
	<body>
		<center>
			<form runat="server" ID="Form1">
				<h3>
					Manage Organizations</h3>
				<asp:datagrid id="datagrid1" runat="server" Font-Size="8pt" Font-Name="verdana" Cellpadding="3"
					...
					<Columns>
						<asp:TemplateColumn HeaderText="Sub GBU">
							...
							<FooterTemplate>
								<asp:TextBox id="OtherBusiness_Add" runat="server" Columns="20" />
							</FooterTemplate>
							<EditItemTemplate>
								<asp:Textbox runat="server" Columns="20" id="OtherBusiness_edit" Text='<%# DataBinder.Eval(Container.DataItem,"value") %>' />
							</EditItemTemplate>
						</asp:TemplateColumn>
