...
Namespace SCLE.User
    Partial Class ReportSummaryPlantExcel
...
#End Region
        ...
        Sub Page_Load(ByVal Src As Object, ByVal E As EventArgs) Handles MyBase.Load
            ...
            Response.AddHeader("Content-Disposition", "inline;filename=PlantSummary.xls")
        ...
        Sub ShowBPEGrid()
            MyCommand = New SqlDataAdapter("SummaryPlant", MyConnection)
