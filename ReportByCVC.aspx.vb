...
#End Region
        ...
        Sub ShowDataGrid()
            MyCommand = New SqlDataAdapter("ProjectsSelectCVC", MyConnection)
        ...
        Sub ShowSumGrid()
            MyCommand = New SqlDataAdapter("ProjectSumCVC", MyConnection)
            MyCommand.SelectCommand.CommandType = CommandType.StoredProcedure
        ...
        Private Sub ExcelExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ExcelExport.Click
            Response.Redirect("ReportbyCVCExcel.aspx?YearField=" & SelectedYear)
        End Sub
    End Class
End Namespace
