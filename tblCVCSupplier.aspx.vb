...
#End Region
        ...
        Sub LoadXML()
            ...
            objdata.ReadXml(Server.MapPath("tblCVCSupplier.xml"))
        ...
        Sub setEditMode(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
            ...
            objdata.Tables("CVCSupplier").DefaultView.RowFilter = "value='" & x1 & "'"
            If objdata.Tables("CVCSupplier").DefaultView.Count > 0 Then
        ...
        Sub DelXML(ByVal S As Object, ByVal E As DataGridCommandEventArgs)
            If E.CommandName = "Delete" Then
                If datagrid1.EditItemIndex = -1 Then
                    ...
                    objdata.Tables("CVCSupplier").DefaultView.RowFilter = "value='" & x1 & "'"
                    If objdata.Tables("CVCSupplier").DefaultView.Count > 0 Then
                        objdata.Tables("CVCSupplier").DefaultView.Delete(0)
                    End If
                    objdata.Tables("CVCSupplier").DefaultView.RowFilter = ""

                    objdata.WriteXml(Server.MapPath("tblCVCSupplier.xml"))
                    LoadXML()
                Else
                    error5.Visible = "True"
                End If
        ...
        Sub UpdateXML(ByVal s As Object, ByVal e As DataGridCommandEventArgs)
            If e.CommandName = "Update" Then
                ...
                If objdata.Tables("CVCSupplier").DefaultView.Count > 0 Then
                    ...
                    txt1 = e.Item.FindControl("CVCSupplier_edit")
                    objdata.Tables("CVCSupplier").Rows(v1).Item("value") = txt1.Text
                    datagrid1.DataSource = objdata
                    datagrid1.DataBind()
        ...
        Sub doInsert(ByVal s As Object, ByVal E As DataGridCommandEventArgs)
            ...
            If E.CommandName = "doAdd" Then
                ...
                tadd1 = E.Item.FindControl("CVCSupplier_Add")

                If tadd1.Text <> "" Then
                    objdata.Tables("CVCSupplier").DefaultView.RowFilter = ""
                    dr = objdata.Tables("CVCSupplier").NewRow()
                    dr(0) = tadd1.Text
                    objdata.Tables("CVCSupplier").Rows.Add(dr)
                    objdata.WriteXml(Server.MapPath("tblCVCSupplier.xml"))
                    LoadXML()
                End If
            End If
