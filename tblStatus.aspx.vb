...
#End Region
        ...
        Sub LoadXML()
            ...
            objdata.ReadXml(Server.MapPath("tblStatus.xml"))
        ...
        Sub setEditMode(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
            ...
            objdata.Tables("tblStatus").DefaultView.RowFilter = "Status='" & x1 & "'"
            If objdata.Tables("tblStatus").DefaultView.Count > 0 Then
        ...
        Sub DelXML(ByVal S As Object, ByVal E As DataGridCommandEventArgs)
            If E.CommandName = "Delete" Then
                If datagrid1.EditItemIndex = -1 Then
                    ...
                    objdata.Tables("tblStatus").DefaultView.RowFilter = "Status='" & x1 & "'"
                    If objdata.Tables("tblStatus").DefaultView.Count > 0 Then
                        objdata.Tables("tblStatus").DefaultView.Delete(0)
                    End If
                    objdata.Tables("tblStatus").DefaultView.RowFilter = ""

                    objdata.WriteXml(Server.MapPath("tblStatus.xml"))
                    LoadXML()
                Else
                    error5.Visible = "True"
                End If
        ...
        Sub UpdateXML(ByVal s As Object, ByVal e As DataGridCommandEventArgs)
            If e.CommandName = "Update" Then
                ...
                If objdata.Tables("tblStatus").DefaultView.Count > 0 Then
                    ...
                    txt1 = e.Item.FindControl("tblStatus_edit")
                    objdata.Tables("tblStatus").Rows(v1).Item("Status") = txt1.Text
                    datagrid1.DataSource = objdata
                    datagrid1.DataBind()
        ...
        Sub doInsert(ByVal s As Object, ByVal E As DataGridCommandEventArgs)
            ...
            If E.CommandName = "doAdd" Then
                ...
                tadd1 = E.Item.FindControl("tblStatus_Add")

                If tadd1.Text <> "" Then
                    objdata.Tables("tblStatus").DefaultView.RowFilter = ""
                    dr = objdata.Tables("tblStatus").NewRow()
                    dr(0) = tadd1.Text
                    objdata.Tables("tblStatus").Rows.Add(dr)
                    objdata.WriteXml(Server.MapPath("tblStatus.xml"))
                    LoadXML()
                End If
            End If
