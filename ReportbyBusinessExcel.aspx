<%@ Page Language="vb" AutoEventWireup="false" Inherits="SCLE.User.ReportbyBusinessExcel" CodeFile="ReportByBusinessExcel.aspx.vb" %>
<HTML>
	<HEAD>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<asp:datagrid id="ProjectDataGrid" OnItemDataBound="ProjectDataGrid_ItemDataBound" runat="server"
				...
				Font-Size="7pt" HeaderStyle-BackColor="#003366" HeaderStyle-Font-Bold=True DataKeyField="ProjectID"
