...
Namespace SCLE.User
    Partial Class ReportAllbyYearExcel
...
#End Region
        ...
        Sub Page_Load(ByVal Src As Object, ByVal E As EventArgs) Handles MyBase.Load
            ...
            Response.AddHeader("Content-Disposition", "inline;filename=YearReport.xls")
            ...
            HeaderLabel.Text = "Project List for Year " & SelectedYear & "-" & SelectedYear + 1
            ShowDataGrid()
            '	ShowSumGrid()
