...
#End Region
        ...
        Sub LoadXML()
            ...
            objdata.ReadXml(Server.MapPath("tblPlant.xml"))
        ...
        Sub setEditMode(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
            ...
            objdata.Tables("tblPlant").DefaultView.RowFilter = "PlantDesc='" & x1 & "'"
            If objdata.Tables("tblPlant").DefaultView.Count > 0 Then
        ...
        Sub DelXML(ByVal S As Object, ByVal E As DataGridCommandEventArgs)
            If E.CommandName = "Delete" Then
                If datagrid1.EditItemIndex = -1 Then
                    ...
                    objdata.Tables("tblPlant").DefaultView.RowFilter = "PlantDesc='" & x1 & "'"
                    If objdata.Tables("tblPlant").DefaultView.Count > 0 Then
                        objdata.Tables("tblPlant").DefaultView.Delete(0)
                    End If
                    objdata.Tables("tblPlant").DefaultView.RowFilter = ""

                    objdata.WriteXml(Server.MapPath("tblPlant.xml"))
                    LoadXML()
                Else
                    error5.Visible = "True"
                End If
        ...
        Sub UpdateXML(ByVal s As Object, ByVal e As DataGridCommandEventArgs)
            If e.CommandName = "Update" Then
                ...
                If objdata.Tables("tblPlant").DefaultView.Count > 0 Then
                    ...
                    txt2 = e.Item.FindControl("Plant_edit")

                    objdata.Tables("tblPlant").Rows(v1).Item("subGBU") = txt1.Text
                    objdata.Tables("tblPlant").Rows(v1).Item("PlantDesc") = txt2.Text
                    datagrid1.DataSource = objdata
                    datagrid1.DataBind()
        ...
        Sub doInsert(ByVal s As Object, ByVal E As DataGridCommandEventArgs)
            ...
            If E.CommandName = "doAdd" Then
                ...
                tadd2 = E.Item.FindControl("Plant_add")

                If tadd1.Text <> "" And tadd2.Text <> "" Then
                    objdata.Tables("tblPlant").DefaultView.RowFilter = ""
                    dr = objdata.Tables("tblPlant").NewRow()
                    dr(0) = tadd1.Text
                    dr(1) = tadd2.Text
                    objdata.Tables("tblPlant").Rows.Add(dr)
                    objdata.WriteXml(Server.MapPath("tblPlant.xml"))
                    LoadXML()
                End If
            End If
