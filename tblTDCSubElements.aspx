<%@ Page Language="vb" AutoEventWireup="false" Inherits="SCLE.Admin.tblTDCSubElements" CodeFile="tblTDCSubElements.aspx.vb" %>
<HTML>
	<body>
		<center>
				...
				<asp:datagrid id="datagrid1" runat="server" Font-Size="8pt" Font-Name="verdana" Cellpadding="3"
					...
					<Columns>
						<asp:TemplateColumn HeaderText="Sub GBU">
							<ItemTemplate>
								<%# DataBinder.Eval(Container.DataItem,"TDCElement") %>
							</ItemTemplate>
							<FooterTemplate>
								<asp:TextBox id="TDCElement_Add" runat="server" Columns="20" />
							</FooterTemplate>
							<EditItemTemplate>
								<asp:Textbox runat="server" Columns="20" id="TDCElement_edit" Text='<%# DataBinder.Eval(Container.DataItem,"TDCElement") %>' />
							</EditItemTemplate>
						</asp:TemplateColumn>
